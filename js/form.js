...
// 	// TODO: Convert to hardcoded HTML
...
// 	let q1Label = document.getElementById('question1');
// 	q1Label.textContent = randQ1Var;
...
// 		let q1a1 = document.getElementById('q1Answer1');
// 		q1a1.textContent=coolA1;
// 		q1a1.value='C';
// 		let q1a2 = document.getElementById('q1Answer2');
// 		q1a2.textContent=neutA1;
// 		q1a2.value='N';
// 		console.log(q1a1,q1a2);
// 	}
...
function renderMonkey() {
  ...
  if (
    happyScore > madScore &&
    happyScore > neutralScore &&
    happyScore > coolScore
  ) {
    ...
    neutralScore > happyScore &&
    neutralScore > madScore &&
    neutralScore > coolScore
  ) {
    name = "neutralMonkey";
    img = "img/Neutral.png";
    duration = 17;
    ...
    coolScore > happyScore &&
    coolScore > madScore &&
    coolScore > neutralScore
  ) {
    name = "coolMonkey";
    img = "img/Cool.png";
    duration = 12;
  ...
  let userCharacter = new SpaceMonkey(name, img, duration, width, height);
...
function handleSubmit(event) {
  ...
  console.log("handleSubmit is firing");
	let scoreArray = [];
  let q1Answer = document.getElementsByName("questionOne");
  for (let i = 0; i < q1Answer.length; i++) {
    if (q1Answer[i].checked) {
      scoreArray.push(q1Answer[i].value);
    }
  }

	let q2Answer = document.getElementsByName("questionTwo");
  for (let i = 0; i < q2Answer.length; i++) {
    if (q2Answer[i].checked) {
      scoreArray.push(q2Answer[i].value);
    }
  }

	let q3Answer = document.getElementsByName("questionThree");
  for (let i = 0; i < q3Answer.length; i++) {
    if (q3Answer[i].checked) {
      scoreArray.push(q3Answer[i].value);
    }
  }

	let q4Answer = document.getElementsByName("questionFour");
  for (let i = 0; i < q4Answer.length; i++) {
    if (q4Answer[i].checked) {
      scoreArray.push(q4Answer[i].value);
    }
  }
	...
	for (let i = 0; i < scoreArray.length; i++) {
		if (scoreArray[i] === "N") {
			neutralScore++;
		} else if (scoreArray[i] === "M") {
			madScore++;
		} else if (scoreArray[i] === "H") {
			happyScore++;
		} else {
			coolScore++;
		}
  ...
  let playerUsername = document
    .getElementById("getusername").value;
